...
- Kafka, Audit y Report se agregaron en bloques posteriores; ver [Eventos Kafka](KAFKA_EVENTOS.md), [Audit](AUDIT_COMPLETO.md) y [Report](REPORT_COMPLETO.md). La integración con frontend, Entra real y AWS sigue pendiente.
