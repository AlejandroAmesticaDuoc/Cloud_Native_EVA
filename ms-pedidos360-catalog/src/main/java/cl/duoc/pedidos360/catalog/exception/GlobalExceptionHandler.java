...
import cl.duoc.pedidos360.catalog.config.TraceIdFilter;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    ResponseEntity<Object> notFound(ProductNotFoundException exception, HttpServletRequest request) {
    ...
    ResponseEntity<Object> conflict(Exception exception, HttpServletRequest request) {
        return response(HttpStatus.CONFLICT, "El producto cambió o existe un conflicto de datos; vuelve a consultar", request);
    }
