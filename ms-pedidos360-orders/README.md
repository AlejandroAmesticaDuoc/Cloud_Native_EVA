...
La creación de pedidos todavía no tiene clave de idempotencia: repetir POST puede crear otro pedido. No se implementó un cobro, mensajería, notificaciones, Audit ni Report. La recuperación de movimientos pendientes se activa al reintentar la misma acción; no existe un proceso automático de reconciliación.
