...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    ResponseEntity<Object> notFound(OrderNotFoundException exception, HttpServletRequest request) {
        return response(HttpStatus.NOT_FOUND, exception.getMessage(), request);
    }

    @ExceptionHandler(OrderConflictException.class)
    ResponseEntity<Object> stockConflict(OrderConflictException exception, HttpServletRequest request) {
        return response(HttpStatus.CONFLICT, exception.getMessage(), request);
    }

    @ExceptionHandler({OptimisticLockingFailureException.class, PessimisticLockingFailureException.class,
            DataIntegrityViolationException.class})
    ResponseEntity<Object> conflict(Exception exception, HttpServletRequest request) {
        return response(HttpStatus.CONFLICT, "El pedido cambió o existe un conflicto de datos; vuelve a consultar", request);
    }
    ...
    ResponseEntity<Object> forbidden(ForbiddenOperationException exception, HttpServletRequest request) {
        return response(HttpStatus.FORBIDDEN, exception.getMessage(), request);
    }

    @ExceptionHandler(CatalogUnavailableException.class)
    ResponseEntity<Object> catalogUnavailable(CatalogUnavailableException exception, HttpServletRequest request) {
